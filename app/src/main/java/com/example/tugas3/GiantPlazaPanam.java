...
public class GiantPlazaPanam extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasirs = "https://goo.gl/maps/UzTbMbu3YYX3BzNbA";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasirs));
            } else if (pilihan.equals("Website")) {
                String website = "https://www.giant.co.id/";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));
            } else if (pilihan.equals("Info di Google")) {
                String info = "https://goo.gl/maps/UzTbMbu3YYX3BzNbA";
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "Giant Panam Pekanbaru");
            }
